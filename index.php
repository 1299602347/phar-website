  ...
  <div class="row">
    <div class="leftcolumn">
      <div class="card1">
        ...
        <div class="fakeimg1" style="height:200px;"><img src="<?php echo $icon2; ?>" alt="" style="width: 100%;"></div>
      ...
      <div class="card2">
        <h2 style="text-align: center; font-size: 40px;"><a style="text-decoration: none;color: black;"
            href="<?php echo $scene; ?>">建筑美景</a></h2>
        <div class="fakeimg2" style="height:200px;"><img src="<?php echo $pic1; ?>" alt=""
